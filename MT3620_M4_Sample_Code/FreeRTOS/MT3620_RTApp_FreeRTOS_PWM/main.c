...
void pwm_task(void *pParameters)
{
	...
	// Init PWM
	ret |= mtk_os_hal_pwm_ctlr_init(pwm_group_led_red, pwm_bitmap_led_red);
	ret |= mtk_os_hal_pwm_ctlr_init(pwm_group_led_green, pwm_bitmap_led_green);
	ret |= mtk_os_hal_pwm_ctlr_init(pwm_group_led_blue, pwm_bitmap_led_blue);
	if (ret) {
	...
	// Configure PWM
	ret |= mtk_os_hal_pwm_feature_enable(pwm_group_led_red, pwm_channel_led_red, GLOBAL_KICK, IO_CTRL, POLARITY_SET);
	ret |= mtk_os_hal_pwm_feature_enable(pwm_group_led_green, pwm_channel_led_green, GLOBAL_KICK, IO_CTRL, POLARITY_SET);
	ret |= mtk_os_hal_pwm_feature_enable(pwm_group_led_blue, pwm_channel_led_blue, GLOBAL_KICK, IO_CTRL, POLARITY_SET);
	if (ret) {
	...
	ret |= mtk_os_hal_pwm_config_freq_duty_normal(pwm_group_led_red, pwm_channel_led_red, pwm_frequency_led_red, pwm_duty_led_red);
	ret |= mtk_os_hal_pwm_config_freq_duty_normal(pwm_group_led_green, pwm_channel_led_green, pwm_frequency_led_green, pwm_duty_led_green);
	ret |= mtk_os_hal_pwm_config_freq_duty_normal(pwm_group_led_blue, pwm_channel_led_blue, pwm_frequency_led_blue, pwm_duty_led_blue);
	if (ret) {
	...
	// Start PWM
	ret |= mtk_os_hal_pwm_start_normal(pwm_group_led_red, pwm_channel_led_red);
	ret |= mtk_os_hal_pwm_start_normal(pwm_group_led_green, pwm_channel_led_green);
	ret |= mtk_os_hal_pwm_start_normal(pwm_group_led_blue, pwm_channel_led_blue);
	if (ret) {
	...
	while (1) {
		...
		pwm_duty_led_red += 1; if (pwm_duty_led_red>1000) pwm_duty_led_red = 0;
		pwm_duty_led_green += 1; if (pwm_duty_led_green>1000) pwm_duty_led_green = 0;
		pwm_duty_led_blue += 1; if (pwm_duty_led_blue>1000) pwm_duty_led_blue = 0;
	...
	// Stop PWM
	ret |= mtk_os_hal_pwm_stop_normal(pwm_group_led_red, pwm_channel_led_red);
	ret |= mtk_os_hal_pwm_stop_normal(pwm_group_led_green, pwm_channel_led_green);
	ret |= mtk_os_hal_pwm_stop_normal(pwm_group_led_blue, pwm_channel_led_blue);
	if (ret) {
	...
	// Deinit PWM
	ret |= mtk_os_hal_pwm_ctlr_deinit(pwm_group_led_red, pwm_bitmap_led_red);
	ret |= mtk_os_hal_pwm_ctlr_deinit(pwm_group_led_green, pwm_bitmap_led_green);
	ret |= mtk_os_hal_pwm_ctlr_deinit(pwm_group_led_blue, pwm_bitmap_led_blue);
	if (ret) {
