...
- ADC0(GPIO41) ~ ADC7(GPIO48) are used as ADC voltage input, users could pump voltage into these pins.  
...
* [AVNET MT3620 Starter Kit](https://www.avnet.com/shop/us/products/avnet-engineering-services/aes-ms-mt3620-sk-g-3074457345636825680/)
    ...
    * Don't remove the jumper on J6, connect ADC1 ~ ADC2 to a 0V ~ 2.5V input.
        ![AVNET ADC](../../BareMetal/MT3620_RTApp_BareMetal_HelloWorld/pic/avnet_adc.png)
* [Seeed MT3620 Development Kit](https://www.seeedstudio.com/Azure-Sphere-MT3620-Development-Kit-US-Version-p-3052.html)
    ...
    * Add a jumper on J1, connect ADC0 ~ ADC3 to a 0V ~ 2.5V input.
        ![Seeed ADC](../..//BareMetal/MT3620_RTApp_BareMetal_HelloWorld/pic/seeed_adc.png)
