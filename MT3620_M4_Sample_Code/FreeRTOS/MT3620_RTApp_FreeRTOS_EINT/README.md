# Sample: MT3620 M4 real-time application - FreeRTOS EINT
### Description
This sample demonstrates how to use EINT on an MT3620 real-time core.  
- On-board LED_Red(GPIO8) and LED_Green(GPIO9) are used as GPIO output.
- On-board Button_A(GPIO12) and Button_B(GPIO13) are used to trigger EINT (External INTerrupt)
- ISU0 UART interface is used to print the output log.
- Users could press Button_A to turn on LED_Red, and release to turn off.
- Users could press Button_B to toggle LED_Green status.  
